...
public class UniqueFrame extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2864348959095979223L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UniqueFrame frame = new UniqueFrame();
	 ...
	 * @throws IOException 
	 */
	public UniqueFrame() throws IOException {
		setResizable(false);
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		BufferedReader bf;
		try {
			bf = new BufferedReader(new FileReader("3_UniqueText.txt"));
		...
		try {
		BufferedWriter writer = new BufferedWriter(new FileWriter("UniqueStarDictonary.txt"));
		...
		FileTableModel n = new FileTableModel("UniqueStarDictonary.txt");
		table = new JTable();
